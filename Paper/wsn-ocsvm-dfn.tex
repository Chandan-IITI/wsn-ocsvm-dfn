...
\IEEEauthorblockA{Department of Communication Engineering,\\School of Electronics and Telecommunications,\\Hanoi University of Science and Technology, Hanoi, Vietnam\\Email: huong.truongthu@hust.edu.vn}}
...
f(\mathbf{x})=\text{sgn} \left( \sum_{i=1}^{N_\text{SV}} \alpha_i^\star k (\mathbf{x}, \mathbf{x}_i )- \rho + \delta \right)
\end{equation}
